...
# Parameters
base_path = ROOT_PATH +'/flickr30k/task1/'
features = 'objectsKCNN'
base_path_save = base_path + features

feats_paths = ['train_' + features + '_places_features.csv',
               'val_' + features + '_places_features.csv',
               'test_' + features + '_places_features.csv']
